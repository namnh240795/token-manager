...
var TokenManager = /** @class */ (function () {
    function TokenManager(_a) {
        var getRefreshToken = _a.getRefreshToken, getAccessToken = _a.getAccessToken, _b = _a.refreshTimeout, refreshTimeout = _b === void 0 ? 3000 : _b, executeRefreshToken = _a.executeRefreshToken, onInvalidRefreshToken = _a.onInvalidRefreshToken, onRefreshTokenSuccess = _a.onRefreshTokenSuccess, isValidRefreshToken = _a.isValidRefreshToken;
        var _this = this;
    ...
    TokenManager.prototype.isTokenValid = function () {
        return __awaiter(this, void 0, void 0, function () {
            var token, decoded, exp, currentTime, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
