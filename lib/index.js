...
exports.injectBearer = exports.parseJwt = void 0;
...
var injectBearer = function (token, configs) {
    var _a;
    if (!configs) {
        return {
            headers: {
    ...
    if ((_a = configs === null || configs === void 0 ? void 0 : configs.headers) === null || _a === void 0 ? void 0 : _a.Authorization) {
        return __assign(__assign({}, configs), { headers: __assign({}, configs.headers) });
    }
    if (configs === null || configs === void 0 ? void 0 : configs.headers) {
        return __assign(__assign({}, configs), { headers: __assign(__assign({}, configs.headers), { Authorization: "Bearer ".concat(token) }) });
    }
    return __assign(__assign({}, configs), { headers: {
            Authorization: "Bearer ".concat(token),
        } });
};
exports.injectBearer = injectBearer;
var TokenManager = /** @class */ (function () {
    ...
    TokenManager.prototype.isTokenValid = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    decoded = (0, exports.parseJwt)(token);
                    exp = decoded.exp;
